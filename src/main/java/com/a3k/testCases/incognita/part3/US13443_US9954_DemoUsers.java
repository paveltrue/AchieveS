...
public class US13443_US9954_DemoUsers extends BasicTestCase {
	...
	private ElementsCollection reportDDLs = $$(By.xpath(".//*[@id='submenu_2']//select"));
	...
	public Object[][] getUsers(){
		Object[][] data = new Object [][]{
				...
				{"ussa13443.alexdemo", "ussa13443.alexdemo", "KidBiz3000", ""},
				{"usda13443.alexdemo", "usda13443.alexdemo", "KidBiz3000", ""},
				{"uskba13443.alexdemo", "uskba13443.alexdemo", "KidBiz3000", ""}
		};
		return data;
	}
	...
	public void check_US13443_US9954_DemoUsers(@Optional() String login,
		...
		homePage.getEditTeacherProfileLink().click();
...
//	}
	...
	public List<String> getTitlesOfPageByListOfSelects(ElementsCollection collection, List<String> fullNames) {
		ArrayList<String> result = new ArrayList<>();
		ElementsCollection temp;
		int count = 0;
		for(int j = 0; j < collection.size(); j++){
			for(int i = 0; i < newReportsPage.getReportNamesFromReportDDL(collection.get(j)).size(); i++){
				String str = newReportsPage.getReportNamesFromReportDDL(collection.get(j)).get(i);
				String str2 = fullNames.get(count);
				newReportsPage.selectFromDDL(collection.get(j), str);
