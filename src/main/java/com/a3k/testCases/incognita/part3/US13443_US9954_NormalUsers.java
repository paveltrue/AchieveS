...
public class US13443_US9954_NormalUsers extends BasicTestCase {
	...
	public Object[][] getUsers(){
		Object[][] data = new Object [][]{
				{"usteach13443.alex","usteach13443.alex","", "Alex Auto Kidbiz 3 Pro"},
	...
	public void check_US13443_US9954_NormalUsers(@Optional() String login, @Optional() String password, @Optional() String program, @Optional() String selectedClass) {

		loginPage = new LoginPage(driver);
		loginPage.loginWithClassAndProgramIfNeededWithAlert(login, password, program,  selectedClass);
		loginPage.afterLoginCheck(program);
		loginPage.afterLoginCheck(program);
