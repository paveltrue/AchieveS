...
public class FiveStep_student_empower extends BasicTestCase {
    ...
    private static String submitPopupContainer;

    private static MyLessons myLessonsPage;
    private static Lesson my_lesson;
    ...
    protected void verifySubmitButton(Lesson lesson) {
        ...
        softAssert.assertEquals(popupContent, submitPopupContainer,
                "Actual popupContent does not equal to expected." + " Actual: " + popupContent + ". Expected: " + submitPopupContainer);
    }
    ...
    public Object[][] getUsers(ITestContext context) {
        ...
        switch (suiteName) {
            ...
            case "SmokeTestUK":
                data = new Object[][]{{"empowerstud.uk", "empowerstud.uk", "", "", "english", "smoke"},};
                break;

            case "SpanishTest":
                data = new Object[][]{{"autoempowersp.stud", "autoempowersp.stud", "", "Empower Class", "spanish", "spanish"},};
                break;

            case "SparkTest":
                data = new Object[][]{{"sparkspanish.stud", "sparkspanish.stud", "", "Spark First Class", "spanish", "spark"}};
                break;

            default:
                data = new Object[][]{{"empowerstud.one", "empowerstud.one", "", "Empower Class 10g", "english", "smoke"}};
